...
mongoose
.connect(
  'mongodb+srv://FaizullahBalghari:Faiz2003@cluster0.ncezhh1.mongodb.net/AdvocateConnect?retryWrites=true&w=majority'
)
...
const transporter = nodemailer.createTransport({
  service: "gmail",
  auth: {
    user: "Mehsudmehsud078@gmail.com",
    pass: "cptb aitu kkcr htux", // App password
  },
});
    ...
    if (existsLawyer && existsUser) {
      ...
      if (!userCases) {
        ...
        await transporter.sendMail({
          from: "Mehsudmehsud078@gmail.com",
...
app.post("/contact-with-admin", async (req, res) => {
  ...
  try {
    ...
    if (user) {
      await transporter.sendMail({
        from: "Mehsudmehsud078@gmail.com",
        to: "Mehsudmehsud078@gmail.com",
        subject: "Contact with admin",
        html: `<p>
      <strong>Dear Admin!</strong>
      <br/> 
      I am user my 
      Name is : ${name} <br/> Email: ${email}<br/>  Message: ${message}
      </p>`,
      });
      ...
      I am lawyer my name is : ${name}<br/> Email: ${email} <br/> Message: ${message}
      </p>`,
      });
      return res.status(200).json({ message: "Message sent successfully" })
    }
